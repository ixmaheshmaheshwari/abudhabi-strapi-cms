...
// Source project path for images
const SOURCE_PROJECT_PATH = '/Users/mahesh/Documents/AbuDhabi-Water-Power-Week';

// Helper function to upload a file and get its ID
async function uploadFile(strapi: Core.Strapi, filePath: string): Promise<number | string | null> {
  try {
    const absolutePath = path.join(SOURCE_PROJECT_PATH, filePath);
    ...
    const uploadedFiles = await strapi.plugins.upload.services.upload.upload({
      ...
      files: {
        path: absolutePath,
        name: fileName,
        type: 'image/' + path.extname(absolutePath).slice(1).replace('svg', 'svg+xml'),
        size: fileStats.size,
      }
    });
...
const seedData = {
  abuDhabiWaterWeekPage: {
    ...
    hero_image: "src/assets/media/AbuDhabiWaterWeekHero.png",
    ...
    explore_image: "src/assets/media/AbuDhabiWaterWeekSide.png",
    ...
    why_exhibitor_image: "src/assets/media/AbuDhabhiAndWaterWeek/ExhibitorAbuDhabhiWater Week.png",
  ...
  topReasons: [
    {
      ...
      image: "src/assets/media/AbuDhabhiAndWaterWeek/GlobalLeaders.png"
    },
    {
      order: 2,
      ...
      image: "src/assets/media/AbuDhabhiAndWaterWeek/InnovationTechnolgy.png"
    },
    {
      order: 3,
      badge_color: "primary",
      ...
      image: "src/assets/media/AbuDhabhiAndWaterWeek/stragicConnection.png"
    },
    {
      order: 4,
      badge_color: "secondary",
      ...
      image: "src/assets/media/AbuDhabhiAndWaterWeek/HighValueKnowledge.png"
    },
    {
      order: 5,
      badge_color: "primary",
      ...
      image: "src/assets/media/AbuDhabhiAndWaterWeek/AbuDhabiWater.png"
    },
    {
      order: 6,
      badge_color: "secondary",
      ...
      image: "src/assets/media/AbuDhabhiAndWaterWeek/ProfessionalGrowth.png"
    }
  ],
  exhibitorReasons: [
    {
      ...
      icon: "src/assets/media/AbuDhabiExhibticor/Leaders.png"
    },
    {
      order: 2,
      badge_color: "secondary",
      ...
      icon: "src/assets/media/AbuDhabiExhibticor/Highlight.png"
    },
    {
      order: 3,
      badge_color: "primary",
      ...
      icon: "src/assets/media/AbuDhabiExhibticor/Parternship.png"
    },
    {
      order: 4,
      badge_color: "secondary",
      ...
      icon: "src/assets/media/AbuDhabiExhibticor/Market.png"
    },
    {
      order: 5,
      badge_color: "primary",
      ...
      icon: "src/assets/media/AbuDhabiExhibticor/Platforn.png"
    },
    {
      order: 6,
      badge_color: "secondary",
      ...
      icon: "src/assets/media/AbuDhabiExhibticor/GlobalExperts.png"
    },
    {
      order: 7,
      badge_color: "primary",
      ...
      icon: "src/assets/media/AbuDhabiExhibticor/RegionalMarket.png"
    }
  ]
};
  ...
  try {
    ...
    if (!existingTopReasons || existingTopReasons.length === 0) {
      ...
      for (const reason of seedData.topReasons) {
        const imageId = await uploadFile(strapi, reason.image);
        
        await strapi.entityService.create('api::top-reason.top-reason', {
          data: {
            order: reason.order,
            badge_color: reason.badge_color as 'primary' | 'secondary',
            title_en: reason.title_en,
            title_ar: reason.title_ar,
      ...
      console.log('✅ Top Reasons seeded successfully!\n');
    } else {
    ...
    if (!existingExhibitorReasons || existingExhibitorReasons.length === 0) {
      ...
      for (const reason of seedData.exhibitorReasons) {
        const iconId = await uploadFile(strapi, reason.icon);
      ...
      console.log('✅ Exhibitor Reasons seeded successfully!\n');
    } else {
    ...
    if (!existingPage || (Array.isArray(existingPage) && existingPage.length === 0) || !existingPage.id) {
      ...
      const page = seedData.abuDhabiWaterWeekPage;
      
      // Upload images
      const heroImageId = await uploadFile(strapi, page.hero_image);
      const exploreImageId = await uploadFile(strapi, page.explore_image);
      const exhibitorImageId = await uploadFile(strapi, page.why_exhibitor_image);
      
      await strapi.entityService.create('api::abu-dhabi-water-week.abu-dhabi-water-week', {
        data: {
          hero_title_en: page.hero_title_en,
          hero_title_secondary_en: page.hero_title_secondary_en,
          hero_title_ar: page.hero_title_ar,
          hero_title_secondary_ar: page.hero_title_secondary_ar,
          hero_description_en: page.hero_description_en,
          hero_description_ar: page.hero_description_ar,
          hero_image: heroImageId,
          explore_heading_en: page.explore_heading_en,
          explore_heading_ar: page.explore_heading_ar,
          explore_para1_en: page.explore_para1_en,
          explore_para1_ar: page.explore_para1_ar,
          explore_para2_en: page.explore_para2_en,
          explore_para2_ar: page.explore_para2_ar,
          explore_image: exploreImageId,
          top_reasons_title_en: page.top_reasons_title_en,
          top_reasons_title_ar: page.top_reasons_title_ar,
          why_exhibitor_heading_en: page.why_exhibitor_heading_en,
          why_exhibitor_heading_ar: page.why_exhibitor_heading_ar,
          why_exhibitor_para1_en: page.why_exhibitor_para1_en,
          why_exhibitor_para1_ar: page.why_exhibitor_para1_ar,
          why_exhibitor_para2_en: page.why_exhibitor_para2_en,
          why_exhibitor_para2_ar: page.why_exhibitor_para2_ar,
          why_exhibitor_image: exhibitorImageId,
          participate_title_en: page.participate_title_en,
          participate_title_ar: page.participate_title_ar,
          world_utilities_title_en: page.world_utilities_title_en,
          world_utilities_title_ar: page.world_utilities_title_ar,
          world_utilities_description_en: page.world_utilities_description_en,
          world_utilities_description_ar: page.world_utilities_description_ar,
          publishedAt: new Date()
        }
      });
      console.log('✅ Abu Dhabi Water Week Page seeded successfully!\n');
    } else {
